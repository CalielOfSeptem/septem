...
public :
              ...
              std::ref(io_service), server_, std::ref(work)))
    {
        ...
        std::string reason;
        std::string path_to_script = "/home/ken/git-repos/Se7enMud/game_data/realms/void";
        entity_manager::Instance().load_entities_from_fs( DEFAULT_REALMS_PATH ); ///"/home/ken/git-repos/Se7enMud/game_data/realms/" );
