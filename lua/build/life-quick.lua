...
arg[0] = '/home/ken/git-repos/Se7enMud/lua/build/test/life-quick.lua'
table.remove(arg, 1)
return assert(loadfile '/home/ken/git-repos/Se7enMud/lua/build/test/life-quick.lua')(unpack(arg))
